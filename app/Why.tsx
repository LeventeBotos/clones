...
export default function Why() {
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 flex justify-center items-center self-center xl:py-48 bg-[#1f1f1f]">
      <div className="container flex justify-center items-center w-full self-center px-4 md:px-6">
        <div className="grid gap-6 self-center items-center">
          <div className="flex flex-col justify-center space-y-8 text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-white to-accent">
            ...
            <div className="w-full max-w-full space-y-4 mx-auto">
              <div className="grid grid-cols-3 gap-8">
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  <div className="p-2 bg-[#1f1f1f] bg-opacity-50 rounded-full">
                    <svg
