  ...
  return (
    <div className="flex gap-5 w-full flex-col">
      <div className="flex flex-col items-center justify-evenly md:flex-row h-96">
        <div className="bg-accent h-96 w-2/3 rounded-xl" />
        <div className=" w-1/4 relative bg-accent rounded-xl p-3 h-80 self-center">
          <div className="absolute top-0 left-0 h-80 w-full flex flex-col rounded-xl justify-evenly items-center text-center bg-white bg-opacity-50">
